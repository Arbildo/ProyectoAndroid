...
public class Navegacion extends AppCompatActivity
    ...
    TextView cajanombre, cajacorreo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cajanombre=(TextView) findViewById(R.id.tvnombre);
        cajacorreo=(TextView) findViewById(R.id.tvcorreo);
        profilePictureView.setProfileId(id);
        cajanombre.setText(jnombre);
        cajacorreo.setText(jcorreo);
